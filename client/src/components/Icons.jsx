...
export const IconThermometer = ({ size = 24, color = "currentColor" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconStar = ({ size = 20, fill = "none", stroke = "currentColor" }) => (
...
export const IconHeight = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 3v18M3 3v18M10 3h4M10 21h4M7 8l3-3 3 3M7 16l3 3 3-3" />
    </svg>
);

export const IconWeight = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M20.5 10a8.5 8.5 0 1 0-17 0" />
        <path d="M2 14h20l-1 7H3l-1-7Z" />
...
export const IconGender = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="m14.83 9.17 3.51-3.51M20 4h-4M20 8V4M9.17 14.83l-3.51 3.51M4 20h4M4 16v4" />
    </svg>
);
...
export const IconScans = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" />
        <polyline points="14 2 14 8 20 8" />
        <circle cx="12" cy="14" r="3" />
        <path d="M12 11v1M12 17v1M9 14h1M14 14h1" />
    </svg>
);
...
export const IconFlask = ({ size = 24, color = "currentColor" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 3h6" />
        <path d="M10 3v13.43a4 4 0 1 0 4 0V3" />
        <path d="M10 8h4" />
    </svg>
);
...
export const IconCloud = ({ size = 24, color = "currentColor" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M17.5 19c2.5 0 4.5-2 4.5-4.5 0-2.3-1.7-4.1-3.9-4.5C17.6 6.8 15 5 12 5c-3.1 0-5.7 2-6.6 4.8C3.1 10.3 1.5 12.5 1.5 15c0 2.5 2 4.5 4.5 4.5h11.5z" />
    </svg>
);
...
export const IconLanguage = ({ size = 20, color = "currentColor" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r="10" />
